...
import com.qtp000.a03cemera_preview.Values12;
...
public class Our_Serial extends AppCompatActivity{
...
/*
//    public Our_Serial(){
//        if(Values12.isserial == Values12.Mode.USB_SERIAL) {  //竞赛平台和a72通过usb转串口通信
//
//        mHandler.sendEmptyMessageDelayed(MESSAGE_REFRESH, REFRESH_TIMEOUT_MILLIS); //启动usb的识别和获取
//        Transparent.showLoadingMessage(this,"加载中",false);//启动旋转效果的对话框，实现usb的识别和获取
//    }
